...
import EventUpdateFormContainer from '../components /events/event_show/event_update_form_container'
...
export default () => ( 
    <div>
        ...
        <ProtectedRoute path='/events/:eventId/update' component={EventUpdateFormContainer}/> 
